...
<section class="py-6 md:py-10 space-y-8">
    ...
    <form method="GET" class="glass-morphism rounded-[2rem] p-6 border border-white/10 flex flex-col md:flex-row items-end gap-4 animate__animated animate__fadeInUp">
