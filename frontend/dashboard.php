    ...
    <section class="glass-morphism rounded-[2.5rem] p-8 md:p-10 border border-white/10">
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <p class="text-xl font-black text-white mb-2">No stores yet</p>
                <p class="text-gray-400 font-medium mb-6">Create your first store to start selling.</p>
                <a href="/dashboard/create-store" class="inline-block btn-primary px-8 py-4 rounded-2xl">Create Your First Store</a>
            </div>
        <?php endif; ?>
    </section>
</section>
