...
<body class="bg-gray-950 text-gray-100 selection:bg-[#ff610a]/30">
        ...
        <div class="glass-morphism rounded-3xl px-6 py-4 border border-white/10">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center gap-6">
                    <?php if ($currentUser): ?>
                        ...
                        <a href="/marketplace" class="inline-flex items-center gap-2 py-2 px-3 text-gray-300 hover:text-white font-bold text-sm transition-all duration-200 relative group">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 pt-4 border-t border-white/10 space-y-3 flex flex-col items-center">
                <?php if ($currentUser): ?>
                    ...
                    <a href="/marketplace" class="flex items-center gap-2 py-2.5 px-5 text-gray-300 hover:text-white font-bold text-sm transition-all duration-200">
    ...
    <?php if (in_array($requestPath, ['', 'marketplace', 'products', 'stores', 'download', 'game']) || str_starts_with($requestPath, 'store/')): ?>
    <!-- Share FAB -->
    ...
    <?php if (!str_starts_with($requestPath, 'game/')): ?>
    ...
    <?php endif; ?>
        <div class="flex flex-col items-stretch gap-2 p-6 pt-20">
            ...
            <?php if ($currentUser): ?>
                <a href="/bill-payment" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                ...
                <a href="/tokens" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                    ...
                    <span>Vomp Wallet</span>
                </a>
                <button onclick="this.nextElementSibling.classList.toggle('hidden');this.querySelector('.chevron').classList.toggle('rotate-180')" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm w-full text-left">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <span>Earn With VOMP</span>
                    <svg class="chevron w-4 h-4 ml-auto transition-transform duration-200" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" /></svg>
                </button>
                <div class="hidden pl-4 space-y-1">
                    <a href="/game" class="flex items-center gap-3 py-2.5 px-4 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                        ...
                        <span>Earn With GamePad</span>
                    </a>
                    <a href="/refer-earn" class="flex items-center gap-3 py-2.5 px-4 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z" /></svg>
                        <span>Refer And Earn</span>
                    </a>
                    <a href="/task-earn" class="flex items-center gap-3 py-2.5 px-4 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                ...
                <a href="/community" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>
                    <span>Vomp Community</span>
                </a>
                <?php if ($currentUser && ($currentUser['role'] ?? 'user') === 'admin'): ?>
                    ...
                    <a href="/admin/email" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm">
            ...
            <?php endif; ?>
            <div class="border-t border-white/10 my-2"></div>
            <button onclick="toggleTheme()" class="flex items-center gap-3 py-3 px-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 transition-all font-bold text-sm w-full text-left">
                <svg id="themeIcon" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z"/></svg>
