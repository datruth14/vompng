...
<section class="py-12 md:py-20">
    ...
    <div class="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
        <div class="glass-morphism rounded-2xl p-6 border border-white/10 text-center">
            <p class="text-3xl md:text-4xl font-black text-white mb-1 animate__animated animate__bounceIn">50</p>
            <p class="text-xs uppercase tracking-widest font-black text-gray-500">Free Vomp Coins</p>
        </div>
        <div class="glass-morphism rounded-2xl p-6 border border-white/10 text-center">
            <p class="text-3xl md:text-4xl font-black text-white mb-1 animate__animated animate__bounceIn">10</p>
            <p class="text-xs uppercase tracking-widest font-black text-gray-500">Vomp Coins Per Product</p>
        </div>
        <div class="glass-morphism rounded-2xl p-6 border border-white/10 text-center">
            <p class="text-3xl md:text-4xl font-black text-white mb-1 animate__animated animate__bounceIn">100%</p>
            <p class="text-xs uppercase tracking-widest font-black text-gray-500">WhatsApp Orders</p>
        </div>
        <div class="glass-morphism rounded-2xl p-6 border border-white/10 text-center">
            <p class="text-3xl md:text-4xl font-black text-white mb-1 animate__animated animate__bounceIn">₦20</p>
...
<!-- How It Works -->
<section class="py-16 md:py-24 animate__animated animate__fadeInUp">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-14">
            <p class="text-xs uppercase tracking-[0.2em] font-black text-[#ff610a] mb-3">Getting Started</p>
            <h2 class="text-4xl md:text-5xl font-black text-white tracking-tight mb-4 animate__animated animate__fadeInDown">How It Works</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="glass-morphism rounded-[2rem] p-8 md:p-10 border border-white/10 text-center relative animate__animated animate__fadeInUp" style="animation-delay: 0.1s">
            ...
            <div class="glass-morphism rounded-[2rem] p-8 md:p-10 border border-white/10 text-center relative animate__animated animate__fadeInUp" style="animation-delay: 0.2s">
                <div class="w-14 h-14 rounded-2xl bg-[#ff610a]/10 border border-[#ff610a]/20 flex items-center justify-center mx-auto mb-6">
            ...
            <div class="glass-morphism rounded-[2rem] p-8 md:p-10 border border-white/10 text-center relative animate__animated animate__fadeInUp" style="animation-delay: 0.3s">
                <div class="w-14 h-14 rounded-2xl bg-[#ff610a]/10 border border-[#ff610a]/20 flex items-center justify-center mx-auto mb-6">
...
<section class="py-16 md:py-24 animate__animated animate__fadeInUp">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-14">
            ...
            <h2 class="text-4xl md:text-5xl font-black text-white tracking-tight mb-4 animate__animated animate__fadeInDown">Everything You Need to Sell</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.1s">
            ...
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.2s">
                <div class="w-12 h-12 rounded-xl bg-[#ff610a]/10 flex items-center justify-center mb-5">
            ...
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.3s">
                <div class="w-12 h-12 rounded-xl bg-[#ff610a]/10 flex items-center justify-center mb-5">
            ...
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.4s">
                <div class="w-12 h-12 rounded-xl bg-[#ff610a]/10 flex items-center justify-center mb-5">
            ...
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.5s">
                <div class="w-12 h-12 rounded-xl bg-[#ff610a]/10 flex items-center justify-center mb-5">
            ...
            <article class="glass-morphism rounded-[2rem] p-8 border border-white/10 hover:bg-white/[0.02] transition-all animate__animated animate__fadeInUp" style="animation-delay: 0.6s">
                <div class="w-12 h-12 rounded-xl bg-[#ff610a]/10 flex items-center justify-center mb-5">
                ...
                <p class="text-gray-400 text-sm leading-relaxed">Built with lean PHP and MySQL — no heavy frameworks, no complex servers. Fast load times even on basic hosting.</p>
            </article>
        </div>
    </div>
</section>
    ...
    <div class="max-w-5xl mx-auto glass-morphism rounded-[2.5rem] p-8 md:p-14 border border-white/10 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            <div class="flex-1">
                ...
                <h2 class="text-3xl md:text-4xl font-black text-white tracking-tight mb-4 animate__animated animate__fadeInDown">Orders Come Directly to Your Phone</h2>
...
<section class="py-16 md:py-24 animate__animated animate__fadeInUp">
    <div class="max-w-4xl mx-auto text-center glass-morphism rounded-[2.5rem] p-10 md:p-16 border border-white/10">
        <h2 class="text-4xl md:text-5xl font-black text-white tracking-tight mb-4 animate__animated animate__fadeInDown">Ready to Start Selling?</h2>
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <?php else: ?>
                <a href="/register" class="btn-press px-10 py-5 rounded-2xl bg-[#ff610a] text-white font-black text-lg shadow-xl shadow-[#ff610a]/20 hover:bg-[#e05500] transition-all animate__animated animate__zoomIn">Create Your Free Store</a>
                <a href="/login" class="px-10 py-5 rounded-2xl glass-morphism border border-white/10 text-white font-black text-lg hover:bg-white/10 transition-all animate__animated animate__zoomIn">I Already Have an Account</a>
            <?php endif; ?>
        </div>
    </div>
</section>
