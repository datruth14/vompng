                    ...
                    <div class="aspect-square skeleton-box relative overflow-hidden">
                        ...
                        <div class="absolute top-2 left-2 flex gap-1">
                            ...
                            <?php if (!empty($p['affiliate_url'])): ?>
                                <span class="px-2 py-0.5 rounded-lg bg-purple-500/20 border border-purple-500/30 text-purple-300 text-[10px] font-black uppercase tracking-wider">Affiliate</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="p-3 md:p-4">
                        <p class="text-sm md:text-lg font-black text-white mb-1"><?php echo htmlspecialchars(product_get_currency_symbol($p['currency'] ?? 'NGN')); ?><?php echo number_format((float)$p['price']); ?></p>
