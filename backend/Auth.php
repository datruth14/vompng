...
/* Register a new user. Never creates a store — use store_create_for_user() separately. */

function auth_register($name, $email, $password, $phone = '')
{
    try {
        ...
        $userStmt->execute([$userId, $email, $hashedPassword, $name, $phone]);
