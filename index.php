...
if ($method === 'GET') {
    switch (true) {
        ...
        case $requestPath === 'games':
            $pageTitle = 'Game Pad - vomp';
            ob_start();
            ?>
            <section class="py-20 text-center">
                <div class="max-w-md mx-auto glass-morphism rounded-[2.5rem] p-12 border border-white/10">
                    ...
                    <h1 class="text-3xl font-black text-white mb-2">Game Pad</h1>
