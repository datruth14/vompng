    ...
    switch (true) {
        ...
        case $requestPath === 'marketplace':
            ...
            if ($searchQuery) {
                ...
                $allProducts = product_get_by_country_currency_paginated($activeCountry, null, 1, 8);
                $searchStores = null;
            } elseif ($activeCategory) {
        ...
        case $requestPath === 'community':
            $pageTitle = 'Vomp Community - vomp';
            ob_start();
            ?>
            <section class="py-20">
                <div class="max-w-lg mx-auto text-center">
                    ...
                    <h1 class="text-4xl md:text-5xl font-black text-white tracking-tight mb-4">Vomp Community</h1>
                    <p class="text-gray-400 text-lg mb-8">Coming Soon</p>
                    <p class="text-gray-500 text-sm">We are building something exciting. Stay tuned!</p>
                </div>
            </section>
